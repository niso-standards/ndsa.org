...
As part of the [review cycle](https://ndsa.org/groups/schedule/), the Levels Working Group re-formed in mid-2024 in order to carry out a targeted revision to the Levels on the topic of environmental sustainability. The focus of this work is a result of community feedback gathered by the Steering Group in 2023 and earlier.  The Levels Working Group completed their task in early 2026 and [all outputs](https://www.ndsa.org/publications/levels-of-digital-preservation/) related to version 2.1 of the Levels of Digital Preservation are available on the NDSA website.   
