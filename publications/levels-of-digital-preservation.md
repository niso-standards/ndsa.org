...
* FRENCH: Translations have been done for the [Matrix V2.0](https://osf.io/y7nbr/), [Implementation Guidelines V2.0](https://osf.io/nt8u9/files/8wyjh) and [Assessment Tool V2.0 Documentation](https://osf.io/xwghf/). A translation of V2.0 is available from the [Bibliotheque nationale de France](https://bnf.hal.science/hal-02551807). A translation for the original matrix (version 1) is also available: [Matrix V1.0](https://osf.io/9ya8c/files/2cxjw) and from the [Bibliotheque nationale de France](https://hal-bnf.archives-ouvertes.fr/hal-02162334)
